...
const url = '../15-FetchAPI%20y%20PHP/inc/models/modelo-contactos.php';
...
function eliminarContacto(e) {
	if (e.target.parentElement.classList.contains('btn-borrar')) {
        ...
        const urlEliminar =  `../15-FetchAPI%20y%20PHP/inc/models/modelo-contactos.php?id=${id}&accion=borrar`;
